...
const MatchesPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Your Matches - Find Compatible Singles | DreamDate"
        description="Discover your perfect matches on DreamDate. Browse compatible singles who share your interests, values, and relationship goals. Find meaningful connections today."
        keywords={["dating matches", "compatible singles", "find matches", "dating compatibility", "relationship matches", "online dating matches"]}
        url="https://dreamdate.app/matches"
      />
