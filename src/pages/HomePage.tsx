                ...
                <div className="space-y-2">
                  {quizSteps[currentStep].options.map((option) => (
                    <Button
                      key={option}
                      variant="outline"
                      className="w-full justify-between text-white border-zinc-600 hover:bg-zinc-700"
      ...
      <div className="bg-zinc-800 py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Create Your Profile", desc: "Sign up in seconds and create your personal profile" },
              { title: "Find Matches", desc: "Browse through potential matches based on your preferences" },
