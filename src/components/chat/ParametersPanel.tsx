...
const ParametersPanel: React.FC = () => {
  ...
  return (
    <div className="w-72 bg-adam-darker border-l border-slate-900/10 p-4 flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-slate-900">Parameters</span>
        </div>
        <button className="text-slate-900/70 hover:text-slate-900">
      ...
      <div className="mt-6">
        <div className="mb-4 rounded-lg overflow-hidden">
          <div className="relative w-full h-24 bg-gradient-to-b from-slate-900 to-transparent">
            <div 
              className="absolute right-2 top-2 w-6 h-6 rounded-full border-2 border-slate-900"
        ...
        <div className="flex justify-between">
          <div className="flex-1 h-10 rounded-lg overflow-hidden">
            <div className="w-full h-full bg-gradient-to-r from-red-500 via-green-500 to-blue-500 relative">
              <div className="absolute right-0 top-0 w-4 h-4 rounded-full border-2 border-slate-900 transform translate-x-1/2 translate-y-1/2"></div>
            </div>
          </div>
        </div>
        <button className="w-full mt-4 py-2 bg-slate-900/10 text-slate-900 rounded-lg flex items-center justify-center gap-2 hover:bg-slate-900/20 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
