...
const MessageList: React.FC<MessageListProps> = ({
  ...
  return <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-none">
      <TooltipProvider>
        ...
        return <div key={message.id} className={`flex items-start gap-3 ${isCurrentUser ? "flex-row-reverse" : ""}`}>
              <Tooltip>
