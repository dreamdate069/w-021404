...
const ConversationList: React.FC<ConversationListProps> = ({
  ...
  // Default to collapsed state for the right sidebar
  ...
  return (
    <TooltipProvider>
      <div className={`h-full border-l border-zinc-800 flex flex-col transition-all duration-300 sticky top-0 right-0 ${
